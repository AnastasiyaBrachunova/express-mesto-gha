...
const { changeUserInfo, changeAvatar, likeCard, dislikeCard, getCards, createCards, deleteCard } = require('../controllers/cards')
...
router.delete('/cards/:id/likes', dislikeCard) // дизлайк карточки
